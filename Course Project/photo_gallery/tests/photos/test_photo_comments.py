...
class PhotoCommentsTest(UserPhotosMixin, TestCase):
    ...
    # Verifies that `edit comment` and `delete comment` are not available options for logged
    # user on other user photo
    def test_logged_user_cannot_modify_other_user_comments(self):
